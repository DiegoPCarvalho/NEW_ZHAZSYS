...
export default function CardsFila(props: CardsFilaProps) {
    ...
    return (
        <div key={props.key} className={`flex z-30 overflow-hidden dark:hover:bg-neutral-700 ${abrir ? "absolute transition-all duration-500 easy-linear w-[510px] max-lg:w-[400px] h-40 max-lg:h-32" : " w-40 max-lg:w-32 max-lg:h-32 h-40 transition-all duration-500 easy-linear"} relative  m-2 bg-white dark:bg-neutral-800 border dark:border-neutral-700 shadow-lg dark:shadow-neutral-800 rounded-lg`}>
            ...
            <div className={`flex flex-col ${abrir ? "transition-x-all" : "hidden"}`}>
                ...
                <div className="flex justify-end h-12 w-full mb-2">
                    <div className="flex w-36 justify-between mr-2">
