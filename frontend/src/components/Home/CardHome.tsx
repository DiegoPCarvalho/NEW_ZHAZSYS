...
export default function CardHome(props: CardHomeProps){
    return (
        <div className="flex w-72 max-[1024px]:w-44 max-2xl:w-[270px] justify-between h-24 bg-white dark:text-neutral-200 dark:bg-neutral-950 dark:border-neutral-600 border-2 shadow-lg rounded-lg mt-3">
